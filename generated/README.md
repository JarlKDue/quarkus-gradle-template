...
./gradlew build
```
It produces the `jaegertest-1.0.0-SNAPSHOT-runner.jar` file in the `/build` directory.
...
The application is now runnable using `java -jar build/jaegertest-1.0.0-SNAPSHOT-runner.jar`.
...
You can then execute your native executable with: `./build/jaegertest-1.0.0-SNAPSHOT-runner`
